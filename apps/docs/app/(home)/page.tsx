    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] antialiased">
      ...
      <nav className="border-b border-[#1a1a1a] sticky top-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-sm">
        <div className="mx-auto max-w-[1100px] flex items-center justify-between px-6 h-14">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="https://github.com/elliot736/janus" target="_blank" rel="noopener noreferrer" className="text-[#888] hover:text-[#ededed] transition-colors" aria-label="GitHub">
      ...
      <section className="mx-auto max-w-[1100px] px-6 py-20">
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <a href="https://github.com/elliot736/janus" target="_blank" rel="noopener noreferrer" className="h-10 px-5 inline-flex items-center gap-2 rounded-md text-[14px] font-medium border border-[#2a2a2a] text-[#888] hover:text-[#ededed] hover:border-[#444] transition-colors">
