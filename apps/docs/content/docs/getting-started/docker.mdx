...
<Callout title="One-click alternatives">
  Don't want to manage Docker yourself? Deploy with [Render](https://render.com/deploy?repo=https://github.com/elliot736/janus), [Coolify](/docs/getting-started/coolify), or [AWS](/docs/getting-started/aws).
</Callout>
