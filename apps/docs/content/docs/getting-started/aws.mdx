...
<Callout title="Simpler options">
  If you don't need AWS, you can deploy with [Docker Compose](/docs/getting-started/docker), [Railway](https://railway.com/template/janus?referralCode=janus), or [Render](https://render.com/deploy?repo=https://github.com/elliot736/janus) instead.
</Callout>
