...
<Callout title="One-click alternatives">
  Don't want to manage Docker yourself? Deploy instantly with [Railway](https://railway.com/template/janus?referralCode=janus) or [Render](https://render.com/deploy?repo=https://github.com/elliot736/janus). For AWS, see [AWS Deployment](/docs/getting-started/aws).
</Callout>
